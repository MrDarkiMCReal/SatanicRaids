...
public abstract class AbstracLocationFinder implements LocationFinder {
    ...
    protected boolean hasNearPlayersInRangeOf(Location loc, int x, int y, int z) {
        return world.getNearbyEntities(loc, x, y, z).stream().anyMatch(e -> e instanceof Player);
    }
