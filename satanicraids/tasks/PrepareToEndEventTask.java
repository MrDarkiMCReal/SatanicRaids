...
public class PrepareToEndEventTask extends BukkitRunnable {
    ...
    public PrepareToEndEventTask(EventWorld world, int timeToDeath) {
    ...
    public void run() {
        ...
        if (timeToDeath % 10 == 0 || timeToDeath <= 5) {
            eventWorld.getRaidWorld().getPlayers().forEach(e ->
    ...
    private void killAllPlayers() {
        World raidWorld = eventWorld.getRaidWorld();
        if (raidWorld != null) {
